...
export function CoursePage() {
  ...
  const availableLessons = [lesson, medicalRecordLesson]
  ...
  return <div className="page-container page-stack">
    ...
    <PageIntro eyebrow="Core foundations" title={course.title} description={course.description}><div className="pill-row"><Pill tone="blue">2 lessons available</Pill><Pill tone="neutral">2 more planned</Pill></div></PageIntro>
    ...
    <section aria-labelledby="lessons-heading"><div className="section-heading section-heading--split compact-heading"><div><p className="eyebrow">Course lessons</p><h2 id="lessons-heading">Build the language in layers</h2></div><span className="muted-copy">2 of {course.lessonCount} ready</span></div>
